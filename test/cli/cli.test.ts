...
describe('CLI Tests', () => {
  ...
  describe('Configuration Parsing', () => {
    it('should parse port configuration', async () => {
      ...
      const config = await import('../../src/cli-functions.js').then(m => m.parseArgs(['--port', '8080']));
    ...
    it('should parse host configuration', async () => {
      ...
      const config = await import('../../src/cli-functions.js').then(m => m.parseArgs(['--host', '0.0.0.0']));
  ...
  describe('Error Handling', () => {
    ...
    it('should handle invalid configuration file', async () => {
      const { stderr, code } = await runCLI(['--config', '/nonexistent/config.json']);
