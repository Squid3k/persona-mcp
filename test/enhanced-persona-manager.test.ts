...
vi.mock('../src/personas/architect.js', () => ({
  architectPersona: {
    ...
    core: {
      ...
      constraints: ['Must be scalable', 'Must be maintainable', 'Must follow patterns']
    },
    behavior: {
      mindset: ['Think strategically', 'Consider long-term impact', 'Balance trade-offs'],
      ...
      antiPatterns: ['Over-engineering', 'Ignoring requirements', 'Poor documentation']
    },
    expertise: {
      domains: ['architecture', 'design', 'patterns', 'scalability'],
      skills: ['system design', 'documentation', 'technical leadership', 'decision making']
    },
...
vi.mock('../src/personas/developer.js', () => ({
  developerPersona: {
    ...
    core: {
      ...
      constraints: ['Must write tests', 'Must follow patterns', 'Must be readable']
    },
    behavior: {
      mindset: ['Code quality first', 'Test everything', 'Keep it simple'],
      methodology: ['Write tests first', 'Implement features', 'Refactor code', 'Document changes'],
      priorities: ['Code quality', 'Test coverage', 'Performance'],
      antiPatterns: ['Copy-paste coding', 'Ignoring tests', 'Premature optimization']
    },
    expertise: {
...
vi.mock('../src/personas/reviewer.js', () => ({
  reviewerPersona: {
    ...
    core: {
      ...
      constraints: ['Must be constructive', 'Must check tests', 'Must verify patterns']
    },
    behavior: {
      mindset: ['Quality matters', 'Details count', 'Help others improve'],
      methodology: ['Check functionality', 'Review tests', 'Verify patterns', 'Suggest improvements'],
    ...
    expertise: {
      ...
      skills: ['critical analysis', 'pattern recognition', 'constructive feedback', 'mentoring']
    },
    decisionCriteria: ['Is it correct?', 'Is it tested?', 'Does it follow standards?'],
...
vi.mock('../src/personas/debugger.js', () => ({
  debuggerPersona: {
    ...
    core: {
      ...
      constraints: ['Must find root cause', 'Must verify fix', 'Must prevent recurrence']
    },
    behavior: {
      mindset: ['Be systematic', 'Question everything', 'Verify assumptions'],
      methodology: ['Reproduce issue', 'Isolate problem', 'Find root cause', 'Implement fix'],
      priorities: ['Find root cause', 'Fix correctly', 'Prevent recurrence'],
      antiPatterns: ['Quick patches', 'Ignoring edge cases', 'Not testing fixes']
    },
    expertise: {
      domains: ['debugging', 'troubleshooting', 'analysis', 'problem solving'],
      skills: ['systematic investigation', 'root cause analysis', 'testing', 'documentation']
    },
    decisionCriteria: ['Is root cause found?', 'Is fix correct?', 'Will it recur?'],
...
describe('EnhancedPersonaManager', () => {
  ...
  const testPersona: LoadedPersona = {
    ...
    core: {
      ...
      constraints: ['Must test edge cases', 'Must verify behavior', 'Must document results']
    },
    behavior: {
      mindset: ['Test-driven', 'Quality focused', 'Detail oriented'],
      methodology: ['Write test cases', 'Execute tests', 'Verify results', 'Document findings'],
      priorities: ['Test coverage', 'Bug detection', 'Documentation'],
      antiPatterns: ['Skipping tests', 'Ignoring edge cases', 'Poor documentation']
    },
    expertise: {
      domains: ['testing', 'quality assurance', 'test automation', 'validation'],
      skills: ['test design', 'test execution', 'bug reporting', 'documentation']
    },
    decisionCriteria: ['Is it testable?', 'Are edge cases covered?', 'Is it documented?'],
    ...
    it('should remove persona by id', () => {
      ...
      const testPersona: Persona = {
        ...
        expertise: {
          ...
          skills: ['test skill 1', 'test skill 2', 'test skill 3', 'test skill 4']
        },
